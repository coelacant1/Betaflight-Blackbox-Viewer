...
while(cap.isOpened()):
  ...
  for i in range(length):
      ...
      if gyroFFT == 0:
          gyro = generateImage(adjustRange(2, i, [gyrox, gyroy, gyroz], 10), ["Gyro X", "Gyro Y", "Gyro Z"], "Gyroscope Data 2 Seconds")
      elif gyroFFT == 1:
          gyro = generateFFTImage(adjustRange(2, i, [gyrox, gyroy, gyroz], 10), ["Gyro X", "Gyro Y", "Gyro Z"], "Gyroscope FFT 2 Seconds")
      elif gyroFFT == 2:
          gyro = generateImage(adjustRange(20, i, [gyrox, gyroy, gyroz], 20), ["Gyro X", "Gyro Y", "Gyro Z"], "Gyroscope Data 20 Seconds")
      elif gyroFFT == 3:
          gyro = generateFFTImage(adjustRange(20, i, [gyrox, gyroy, gyroz], 20), ["Gyro X", "Gyro Y", "Gyro Z"], "Gyroscope FFT 20 Seconds")

      if motorFFT == 0:
          motor = generateImage(adjustRange(2, i, [motor0, motor1, motor2, motor3], 10), ["Motor 0", "Motor 1", "Motor 2", "Motor 3"], "Motor Data 2 Seconds")
      elif motorFFT == 1:
          motor = generateFFTImage(adjustRange(2, i, [motor0, motor1, motor2, motor3], 10), ["Motor 0", "Motor 1", "Motor 2", "Motor 3"], "Motor FFT 2 Seconds")
      elif motorFFT == 2:
          motor = generateImage(adjustRange(20, i, [motor0, motor1, motor2, motor3], 20), ["Motor 0", "Motor 1", "Motor 2", "Motor 3"], "Motor Data 20 Seconds")
      elif motorFFT == 3:
          motor = generateFFTImage(adjustRange(20, i, [motor0, motor1, motor2, motor3], 20), ["Motor 0", "Motor 1", "Motor 2", "Motor 3"], "Motor FFT 20 Seconds")

      if contrFFT == 0:
          contr = generateImage(adjustRange(2, i, [contr0, contr1, contr2, contr3], 10), ["Control 0", "Control 1", "Control 2", "Control 3"], "Control Data 2 Seconds")
      elif contrFFT == 1:
          contr = generateFFTImage(adjustRange(2, i, [contr0, contr1, contr2, contr3], 10), ["Control 0", "Control 1", "Control 2", "Control 3"], "Control FFT 2 Seconds")
      elif contrFFT == 2:
          contr = generateImage(adjustRange(20, i, [contr0, contr1, contr2, contr3], 20), ["Control 0", "Control 1", "Control 2", "Control 3"], "Control Data 20 Seconds")
      elif contrFFT == 3:
          contr = generateFFTImage(adjustRange(20, i, [contr0, contr1, contr2, contr3], 20), ["Control 0", "Control 1", "Control 2", "Control 3"], "Control FFT 20 Seconds")

      if headFFT == 0:
          head = generateImage(adjustRange(2, i, [head0, head1, head2], 10), ["Heading 0", "Heading 1", "Heading 2"], "Heading Data 2 Seconds")
      elif headFFT == 1:
          head = generateFFTImage(adjustRange(2, i, [head0, head1, head2], 10), ["Heading 0", "Heading 1", "Heading 2"], "Heading FFT 2 Seconds")
      elif headFFT == 2:
          head = generateImage(adjustRange(20, i, [head0, head1, head2], 20), ["Heading 0", "Heading 1", "Heading 2"], "Heading Data 20 Seconds")
      elif headFFT == 3:
          head = generateFFTImage(adjustRange(20, i, [head0, head1, head2], 20), ["Heading 0", "Heading 1", "Heading 2"], "Heading FFT 20 Seconds")
      ...
      cv2.imwrite("export/image_processed_" + str(i) + ".png", added_image)
